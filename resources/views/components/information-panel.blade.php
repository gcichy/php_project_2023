...
<div class="mt-6 flex flex-col xl:flex-row border-gray-300 xl:bg-white justify-between items-center">
    ...
    <div class="mt-4 xl:mt-0 w-full xl:w-3/4 flex justify-center xl:justify-end align-middle">
        {{$slot}}
    </div>
</div>
