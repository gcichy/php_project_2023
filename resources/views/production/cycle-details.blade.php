...
{{--                                    </th>--}}
                        ...
                        <!-- Edit user modal -->
                        <div id="editUserModal" tabindex="-1" aria-hidden="true" class="absolute top-0 left-0 right-0 z-[150] items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
